...
df = pd.read_csv(r"C:\Users\Pulkit Verma\Desktop\HealthApp\data\diabetes.csv")
...
joblib.dump(model,r"C:\Users\Pulkit Verma\Desktop\HealthApp\Indivisual_Deployment\Diabetes_API\diabetes_model.pkl")
